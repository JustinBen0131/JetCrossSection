...
treeOutName="${outputDir}/JetValOutput_${filename%.*}.root"  # Strip the extension from the filename and append
...
root -b -l -q "macros/Fun4All_JetVal.C(\"$filename\", $events, \"$treeOutName\")"
